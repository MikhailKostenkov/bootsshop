...
<body>
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item" data-bs-interval="5000" style="background-color: #FF3A4C;">
          ...
          <a class="navbar-brand" href="index.php">
                    <img src="img/yaankilogo.png" alt="logo">
                  </a>
            <nav class="navbar navbar-expand-lg">
                <div class="container-fluid">
    ...
    <section id="mailing">
      ...
      <div class="rectangle9">
        ...
        <img class="logoblack" src="img/logos/yaanki.png" alt="logoblack">
        <h1>Получай самые свежие новости
          и предложения от Yaanki</h1>

        <p>Подпишись на рассылку, чтобы получать новости
          и выгодные предложения от Yaanki.</p>
        ...
        <p class="policy">Оформляя подписку ты принимаешь <a href="#mailing">Политику конфиденциальности</a>
          и <a href="#mailing">Условия использования</a> </p>
      </div>
